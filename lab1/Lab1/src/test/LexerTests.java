...
public class LexerTests {
	...
	public void testKeywords() {
		runtest("boolean",
				new Token(BOOLEAN, 0, 0, "boolean"), new Token(EOF, 0, 7, ""));
	}
	
	@Test
	public void testComplex() {
		runtest("if ( number1 >= number2){\n number1=number2 - 12;\n}",
				new Token(IF, 0, 0, "if"), 
				new Token(LPAREN, 0, 3, "(" ),
		        new Token(ID,0,5,"number1"),
		        new Token(GEQ,0,13,">="),
		        new Token(ID,0,16,"number2"),
		        new Token(RPAREN,0,23,")"),
		        new Token(LCURLY,0,24,"{"),
		        new Token(ID,1,1,"number1"),
		        new Token(EQL,1,8,"="),
		        new Token(ID,1,9,"number2"),
		        new Token(MINUS,1,17,"-"),
		        new Token(INT_LITERAL,1,19,"12"),
		        new Token(SEMICOLON,1,21,";"),
